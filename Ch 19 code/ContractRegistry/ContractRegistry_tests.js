describe('ContractRegistry', function() {
  ...
  function() {
    var funcName = 'getFullName', 
        hasNames = 'hasNames', // Name of contract
        funcObj;
    ...
    describe('aspect functionality', function() {
      ...
      it('calls through to decorated object if object fulfills the contract',
      function() {
      ...
      it('throws if the decorated object does not fulfill the contract',
      function(){
        registry.attachPreCallValidator(funcName,funcObj,hasNames);
      ...
      it('does not throw if the decorated object fulfills the contract',
      function() {
        registry.attachPreCallValidator(funcName,funcObj,hasNames);
